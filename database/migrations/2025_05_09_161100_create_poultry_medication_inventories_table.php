...
return new class extends Migration
{
    ...
    {
        Schema::create('poultry_medication_inventories', function (Blueprint $table) {
            $table->id();
            $table->foreignId('poultry_medication_id')->constrained()->onDelete('cascade');
            $table->foreignId('medication_product_id')->constrained()->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('poultry_medication_inventories');
    }
};
