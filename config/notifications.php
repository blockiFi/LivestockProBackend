    ...
    'types' => [
        ...
        */
        ...
        NotificationType::SYSTEM_ANNOUNCEMENT => [
            ...
            'priority' => NotificationPriority::LOW,
            'channels' => ['in_app', 'email'],
            'template' => 'emails.notifications.announcement',
        ...
        NotificationType::PLATFORM_BROADCAST => [
            ...
            'locked' => ['in_app'],
            'template' => 'emails.notifications.announcement',
            'description' => 'Announcements from the Farm Central team.',
        ],
        ...
        NotificationType::CUSTOMER_ACCOUNT_TOP_UP => [
            'label' => 'Customer account top-up',
            'category' => NotificationCategory::FARM_OPERATIONS,
            'priority' => NotificationPriority::NORMAL,
            'channels' => ['in_app', 'email'],
            'template' => 'emails.notifications.generic',
            'description' => 'A customer prepaid account was credited.',
        ],
        NotificationType::CUSTOMER_ACCOUNT_PAYMENT => [
            'label' => 'Customer account payment',
            'category' => NotificationCategory::FARM_OPERATIONS,
            'priority' => NotificationPriority::NORMAL,
            'channels' => ['in_app', 'email'],
            'template' => 'emails.notifications.generic',
            'description' => 'A sale was paid from a customer prepaid account.',
        ],
        NotificationType::CUSTOMER_ACCOUNT_LOW_BALANCE => [
            'label' => 'Customer account low balance',
            'category' => NotificationCategory::FARM_OPERATIONS,
            'priority' => NotificationPriority::HIGH,
            'channels' => ['in_app', 'email'],
            'template' => 'emails.notifications.generic',
            'description' => 'A customer prepaid balance fell below its threshold.',
        ],
    ],
];
